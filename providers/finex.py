...
def etf_finex(driver):
    ...
    WebDriverWait(driver, timeout=20).until(expected_conditions.element_to_be_clickable((By.CLASS_NAME, "agreeCheckbox-0-2-124")))
    driver.find_element(By.CLASS_NAME, "agreeCheckbox-0-2-124").click()
    WebDriverWait(driver, timeout=20).until(expected_conditions.element_to_be_clickable((By.CLASS_NAME, "button-0-2-127")))
    driver.find_element(By.CLASS_NAME, "button-0-2-127").click()

    # Waiting for the presence of the table.
    WebDriverWait(driver, timeout=20).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, "root-0-2-62")))
