...
def etf_invesco_irl(driver):
    ...
    WebDriverWait(driver, timeout=20).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, "view-content")))
...
def etf_invesco_usa(driver):
    ...
    # Waiting for the presence of the table.
    WebDriverWait(driver, timeout=20).until(expected_conditions.presence_of_element_located((By.ID, "etfPerformancesTable")))
