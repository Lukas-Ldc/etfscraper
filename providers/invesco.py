...
def etf_invesco_irl(driver):
    ...
    WebDriverWait(driver, timeout=10).until(expected_conditions.element_to_be_clickable((By.XPATH, "//button[@class='private']")))
    driver.find_element(By.XPATH, "//button[@class='private']").click()
    WebDriverWait(driver, timeout=10).until(expected_conditions.element_to_be_clickable((By.ID, "overlay_button_submit")))
...
def etf_invesco_usa(driver):
    ...
    # Interaction with the type of investor.
    WebDriverWait(driver, timeout=10).until(expected_conditions.element_to_be_clickable((By.ID, "Individual Investor")))
    ...
    # Waiting for the presence of the table.
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.ID, "etfPerformancesTable")))
