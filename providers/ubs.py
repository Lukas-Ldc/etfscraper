...
def etf_ubs(driver):
    ...
    WebDriverWait(driver, timeout=10).until(expected_conditions.element_to_be_clickable((By.CLASS_NAME, "privacysettings__declineAllCookies")))
    driver.find_element(By.CLASS_NAME, "privacysettings__declineAllCookies").click()

    # Interaction with type of investor.
    WebDriverWait(driver, timeout=10).until(expected_conditions.element_to_be_clickable((By.ID, "privateinvestors--id-2-label")))
    ...
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, "contextdisclaimer__footer--sticky-visible")))
    ...
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, "MuiTableBody-root")))
    ...
    sleep(2)
    WebDriverWait(driver, timeout=10).until(expected_conditions.element_to_be_clickable((By.CLASS_NAME, "dropdown-container-button")))
    driver.find_element(By.CLASS_NAME, "dropdown-container-button").click()
    WebDriverWait(driver, timeout=10).until(expected_conditions.element_to_be_clickable((By.CLASS_NAME, "item")))
