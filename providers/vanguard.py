...
def etf_vanguard_irl(driver):
    ...
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.ID, "mat-select-0")))
    driver.find_element(By.ID, "mat-select-0").click()
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.ID, "mat-option-0")))
    driver.find_element(By.ID, "mat-option-0").click()
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.ID, "investorType")))
    driver.find_element(By.ID, "investorType").click()
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.ID, "mat-option-22")))
    driver.find_element(By.ID, "mat-option-22").click()
    WebDriverWait(driver, timeout=10).until(expected_conditions.presence_of_element_located((By.XPATH, "//europe-core-consent-box[.//button]")))
